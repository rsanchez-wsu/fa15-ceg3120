...
public class DataAccessLayer extends Thread{
	 ...
	 *
	 * <p>This list allows us to keep in line which request we need to handle first.  This will
	 * help avoid DataBase issues that would otherwise arise.
	 *
	 * @param inputData Object being requested.
	 ...
	 * to the DB.
	 *
	 * <p>Take the input data and request type and process it.
	 *
	 * @param inputData Read request object.
	 * @param reqType Type of request being served.
	 ...
	 *
	 * @param inputObject Create-type request object.
	 ...
	 * @param inputData Read-type request object.
	 ...
	 * @param inputObject Update-type request object.
	 * @return false for now.
	 */
	 ...
	 * @param inputObject Delete-type request object.
	 * @return false for now.
	 */
	 ...
	 *
	 * <p>NOTE:  This will not check for requests for Read requests.  Since Reading will need
