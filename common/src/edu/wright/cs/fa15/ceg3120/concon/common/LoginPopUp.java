...
public class LoginPopUp {
	...
	private void buildGui() {
		...
		/*
		 * need action listener for submit button that will block until we
		 * receive a response from Networking so user can be set properly.
		 * Preferably a blocking mechanism that will timeout when we want it to.
		 */
