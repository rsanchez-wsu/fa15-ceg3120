...
public class TabbedFrame extends javax.swing.JFrame {
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        scheduleData.setMonth((String)jComboBox1.getSelectedItem());
        scheduleData.setDay((int) jComboBox2.getSelectedItem());
        scheduleData.setTimeRange((String)jComboBox3.getSelectedItem());
